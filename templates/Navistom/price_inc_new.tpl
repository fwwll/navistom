        ...
        <div id="success_form">
            <div>
                <ul class="menu_folding" style="font: 12px/1.2 Arial,Helvetica ,sans-serif !important">
                    <li>
                        ...
                        <div class="position_right">
                            <label class="custom-select">
                                <select id="top_s">
                                    <option value="1">30 дней - 196 грн</option>
                                    <option value="2">20 дней - 154 грн</option>
                                    <option value="3" selected="selected">10 дней - 98 грн</option>
                                </select>
                            </label>
                            <span class="all_price">&nbsp;&nbsp;&nbsp;<span
                                        class="price color_000005"> 98 </span>грн</span>
                        </div>
                    </li>
                    <li>
                        <div class="position_left">
                            <input type="checkbox" class="vip-checkbox" id="konc_i" name="show_competitor" value="3konc"
                                   nouniform="true">
                            <label for="konc_i">
                                <div></div>
                            </label>
                        ...
                        <div class="position_right">
                            ...
                            <span class="all_price">&nbsp;&nbsp;&nbsp;<span
                                        class="price color_000005"> 112 </span>грн</span>
                        </div>
                    </li>
                    <li>
                        <div class="position_left">
                            <input type="checkbox" class="vip-checkbox" name="color_yellow" id="yellow_i" value="28"
                                   nouniform="true">
                            <label for="yellow_i">
                                <div></div>
                            </label>
                        ...
                        <div class="position_right">
                            <span class="all_price">&nbsp;&nbsp;&nbsp;<span
                                        class="price color_000005"> 28 </span>грн</span>
                        </div>
                    </li>
                    <li>
                        <div class="position_left">
                            <input type="checkbox" class="vip-checkbox" name="urgently" checked='checked' id="urgently"
                                   value="28" nouniform="true">
                            <label for="urgently">
                                <div class="c_ck"></div>
                            </label>
                        </div>
                    ...
                    <li>
                        <div class="position_left">
                            <input type="checkbox" class="vip-checkbox" id="update_date" name="update_date" value="28"
                                   nouniform="true">
                    ...
                    <li>
                        <div class="position_left">
                            <input type="checkbox" class="vip-checkbox" id="jurnal_i" name="jurnal" value="jurnal1"
                                   nouniform="true">
                            <label for="jurnal_i">
                                <div></div>
                            </label>
