...
<html>
<head>
    <link rel="icon" href="/templates/Navistom/images/navi-favicon.png" type="image/x-icon">
    {% if json_breadcrumb %}
            ...
            <div class=' all_bottom'>
                ...
                <div class='menu_top_right'>
                    ...
                    <ul>
                        ...
                        <li>
                            &gt;<a href="/product/add" target="_self" class='' title="Продам новое"> Продам новое</a>
                        </li>
                        <li>
                            &gt;<a href="/ads/add" target="_self" class='' title="Продам Б/У"> Продам Б/У</a>
                        </li>
                        <li>
                            &gt;<a href="/service/add" target="_self" class='' title="Сервис/Запчасти">
                                Сервис/Запчасти</a>
                        </li>
                        <li>
                            &gt;<a href="/demand/add" target="_self" class='' title="Спрос"> Спрос/Куплю</a>
                        </li>
                        <li>
                            &gt;<a href="/activity/add" target="_self" class='' title="Мероприятия"> Мероприятия</a>
                        </li>
                        <li>
                            &gt;<a href="/lab/add" target="_self" class='' title="З/Т лаборатории"> З/Т лаборатории</a>
                        </li>
                        <li>
                            &gt;<a href="/realty/add" target="_self" class='' title="Недвижимость"> Недвижимость</a>
                        </li>
                        <!--li>
                                           &gt;<a href="/diagnostic/add" target="_self" class='ajax-link' title="Диагностика"> Диагностика</a>
                                        </li-->
                        <li>
                            &gt;<a href="/work/resume/add" target="_self" class='' title="Резюме"> Резюме</a>
                        </li>
                        <li>
                            &gt;<a href="/work/vacancy/add" target="_self" class='' title="Вакансии"> Вакансии</a>
                        </li>
                    </ul>
                    <div class='close'>
...
<div id="parent" class="clear">
    <div id="main" class="clear">
        {% if route.action !='add' and route.action !='login' and route.action != 'registration' and route.action !='usersAgreement'
        and route.action !='vacancyAdd'  and route.action !='resumeAdd' and route.controller!='cabinet' and route.controller!='payment' %}
        ...
        {% if user_info %}
            ...
            {% endif %}
        {% endif %}
        {% if title != '' and route.controller != 'main' and  route.action !='add' %}
...
{#{renderCss('all.min.js' , 'script')|raw}#}
