...
{% block content %}
    <noindex>
    <div id="left">
    <div class='background_filter' style="height:230px">
        <h4><i class="navs-icon-bu"></i>Продам Б/У</h4>
                ...
                <div class=" clear">
                    {% if a.url_full %}
                        <a title="{{ a.product_name }}, Б/У" href="/ads/{{ a.ads_id }}-{{ a.product_name|translit }}"
                           class="ajax-link image_pad"><img title="{{ a.product_name }}, Б/У"
                                                            alt="{{ a.product_name }}, Б/У"
        ...
        <ul class="a-pagination">
            ...
            <li>
                {% if pagination.prev_page > 1 %}
                    {% if route.values.user_id > 0 %}
                        <a href="/ads/page-{{ pagination.prev_page }}{{ url }}">Предыдущая</a>
                    {% elseif route.values.categ_id > 0 %}
                        {% if route.values.producer_id > 0 %}
                            <a href="/ads/page-{{ pagination.prev_page }}/categ-{{ route.values.categ_id }}/firm-{{ route.values.producer_id }}-{{ route.values.translit }}">Предыдущая</a>
                        {% elseif route.values.product_id > 0 %}
                            <a href="/ads/page-{{ pagination.prev_page }}/categ-{{ route.values.categ_id }}/product-{{ route.values.product_id }}-{{ route.values.translit }}">Предыдущая</a>
                        {% else %}
                            <a href="/ads/page-{{ pagination.prev_page }}/categ-{{ route.values.categ_id }}-{{ route.values.translit }}">Предыдущая</a>
                        {% endif %}
                    {% elseif route.values.sub_categ_id > 0 %}
                        {% if route.values.producer_id > 0 %}
                            <a href="/ads/page-{{ pagination.prev_page }}/sub_categ-{{ route.values.sub_categ_id }}/firm-{{ route.values.producer_id }}-{{ route.values.translit }}">Предыдущая</a>
                        {% elseif route.values.product_id > 0 %}
                            <a href="/ads/page-{{ pagination.prev_page }}/sub_categ-{{ route.values.sub_categ_id }}/product-{{ route.values.product_id }}-{{ route.values.translit }}">Предыдущая</a>
                        {% else %}
                            <a href="/ads/page-{{ pagination.prev_page }}/sub_categ-{{ route.values.sub_categ_id }}-{{ route.values.translit }}">Предыдущая</a>
                        {% endif %}
                    {% elseif route.values.user_id > 0 %}
                        <a href="/ads/page-{{ pagination.prev_page }}/user-{{ route.values.user_id }}-{{ route.values.translit }}">Предыдущая</a>
                    {% elseif route.values.producer_id > 0 %}
                        <a href="/ads/page-{{ pagination.prev_page }}/firm-{{ route.values.producer_id }}-{{ route.values.translit }}">Предыдущая</a>
                    {% elseif route.values.product_id > 0 %}
                        <a href="/ads/page-{{ pagination.prev_page }}/product-{{ route.values.product_id }}-{{ route.values.translit }}">Предыдущая</a>
                    {% else %}
                        <a href="/ads/page-{{ pagination.prev_page }}">Предыдущая</a>
                    {% endif %}
                {% endif %}
            </li>
