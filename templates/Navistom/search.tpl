...
{% block content %}
    ...
    {% for n in search_result %}
        ...
        {% if n.type == 'products_new' %}
            <div class="item pagination-block {% if is_admin and n.flag_moder_view == 0 %}no-moder-view{% endif %} {% if n.light_flag %}light{% endif %}">
                <div class="a-row a-offset-0">
                    <div class="a-cols-2 a-font-small a-color-gray-2"><a href="/products">Продам новое</a></div>
                ...
                <div class="offer clear">
                    {% if n.image != '' %}
                        <img title="{{ n.name }}" src="/uploads/images/products/80x100/{{ n.image }}">
                    {% else %}
                        <img title="{{ n.name }}" src="/uploads/images/100x80.jpg">
                    {% endif %}
                    <div class="offer-content">
                        <a title="{{ p.product_name }}" class="ajax-link"
                           href="/product/{{ n.content_id }}-{{ n.name|translit }}">{{ n.name }}</a>
                            ...
                            <li>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                        ...
                                        <li>
                                            <a class="ajax-link" href="/light-content-3-{{ n.content_id }}"><i
                                                        class="a-icon-tint a-icon-gray"></i> Выделить цветом</a>
                                        </li>
                                        <li>
                                            <a class="ajax-link" href="/add-to-top-3-{{ n.content_id }}"><i
                                                        class="a-icon-circle-arrow-up a-icon-gray"></i> VIP авто</a>
                                        </li>
                                        <li>
                                            <a class="ajax-link" href="/add-to-top-main-3-{{ n.content_id }}"><i
        ...
        {% elseif n.type == 'ads' %}
            <div class="item pagination-block {% if is_admin and n.flag_moder_view == 0 %}no-moder-view{% endif %} {% if n.light_flag %}light{% endif %}">
                <div class="a-row a-offset-0">
                    <div class="a-cols-2 a-font-small a-color-gray-2"><a href="/ads">Продам Б/У</a></div>
                    <div style="font-size:10px"
                         class="a-cols-4 a-font-small a-color-gray-2 a-align-right a-float-right">
                        {{ n.date_add|timeago }}
                    </div>
                ...
                <div class="offer clear">
                    {% if n.image != 'products/80x100/' %}
                        <img title="{{ n.name }}, Б/У" alt="{{ n.name }}, Б/У" src="/uploads/images/{{ n.image }}"/>
                    {% else %}
                        <img src="/uploads/images/100x80.jpg"/>
                    {% endif %}
                    <div class="offer-content">
                        <a title="{{ n.name }}, Б/У" class="ajax-link"
                           href="/ads/{{ n.content_id }}-{{ n.name|translit }}"> {{ n.name }}, Б/У</a>
                            ...
                            <li>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                        ...
                                        <li>
                                            <a class="ajax-link" href="/light-content-4-{{ n.content_id }}"><i
                                                        class="a-icon-tint a-icon-gray"></i> Выделить цветом</a>
                                        </li>
                                        <li>
                                            <a class="ajax-link" href="/add-to-top-4-{{ n.content_id }}"><i
                                                        class="a-icon-circle-arrow-up a-icon-gray"></i> VIP авто</a>
                                        </li>
                                        <li>
        ...
        {% elseif n.type == 'activity' %}
            <div class="item pagination-block {% if is_admin and n.flag_moder_view == 0 %}no-moder-view{% endif %} {% if n.light_flag %}light{% endif %}">
                <div class="a-row a-offset-0">
                    <div class="a-cols-2 a-font-small a-color-gray-2"><a href="/activity">Мероприятия</a></div>
                    <div style="font-size:10px"
                         class="a-cols-4 a-font-small a-color-gray-2 a-align-right a-float-right">
                        {{ n.date_add|timeago }}
                    </div>
                ...
                <div class="offer clear">
                    {% if n.image %}
                        <div class="lector-image">
                            <img title="{{ n.name }}" alt="{{ n.name }}" src="/uploads/images/activity/{{ n.image }}"/>
                        </div>
                    {% else %}
                        <img src="/uploads/images/100x80.jpg"/>
                    {% endif %}
                    <div class="offer-content">
                        ...
                        <a title="{{ n.name }}" class="ajax-link"
                           href="/activity/{{ n.content_id }}-{{ n.name|translit }}">{{ n.name|raw }}</a>
                            ...
                            <li>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                        ...
                                        <li>
                                            <a class="ajax-link" href="/light-content-5-{{ n.content_id }}"><i
                                                        class="a-icon-tint a-icon-gray"></i> Выделить цветом</a>
                                        </li>
                                        <li>
                                            <a class="ajax-link" href="/add-to-top-5-{{ n.content_id }}"><i
                                                        class="a-icon-circle-arrow-up a-icon-gray"></i> VIP авто</a>
                                        </li>
                                        <li>
        ...
        {% elseif n.type == 'labs' %}
            <div class="item pagination-block {% if is_admin and n.flag_moder_view == 0 %}no-moder-view{% endif %} {% if n.light_flag %}light{% endif %}">
                <div class="a-row a-offset-0">
                    <div class="a-cols-2 a-font-small a-color-gray-2"><a href="/labs">З/Т лаборатории</a></div>
                    <div style="font-size:10px"
                         class="a-cols-4 a-font-small a-color-gray-2 a-align-right a-float-right">
                        {{ n.date_add|timeago }}
                    </div>
                ...
                <div class="offer clear">
                    {% if n.image != '' %}
                        <img title="{{ n.name }}" alt="{{ n.name }}" src="/uploads/images/labs/80x100/{{ n.image }}"/>
                    {% else %}
                        <img src="/uploads/images/100x80.jpg"/>
                    {% endif %}
                    <div class="offer-content">
                            ...
                            <li>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                        ...
                                        <li>
                                            <a class="ajax-link" href="/light-content-7-{{ n.content_id }}"><i
                                                        class="a-icon-tint a-icon-gray"></i> Выделить цветом</a>
                                        </li>
                                        <li>
                                            <a class="ajax-link" href="/add-to-top-7-{{ n.content_id }}"><i
                                                        class="a-icon-circle-arrow-up a-icon-gray"></i> VIP авто</a>
                                        </li>
                                        <li>
        ...
        {% elseif n.type == 'realty' %}
            <div class="item pagination-block {% if is_admin and n.flag_moder_view == 0 %}no-moder-view{% endif %} {% if n.light_flag %}light{% endif %}">
                <div class="a-row a-offset-0">
                    <div class="a-cols-2 a-font-small a-color-gray-2"><a href="/realty">Недвижимость</a></div>
                    <div style="font-size:10px"
                         class="a-cols-4 a-font-small a-color-gray-2 a-align-right a-float-right">
                        {{ n.date_add|timeago }}
                    </div>
                ...
                <div class="offer clear">
                    {% if n.image != '' %}
                        <img title="{{ n.name }}" alt="{{ n.name }}" src="/uploads/images/realty/80x100/{{ n.image }}"/>
                    {% else %}
                        <img src="/uploads/images/100x80.jpg"/>
                    {% endif %}
                    <div class="offer-content">
                            ...
                            <li>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                        ...
                                        <li>
                                            <a class="ajax-link" href="/light-content-8-{{ n.content_id }}"><i
                                                        class="a-icon-tint a-icon-gray"></i> Выделить цветом</a>
                                        </li>
                                        <li>
                                            <a class="ajax-link" href="/add-to-top-8-{{ n.content_id }}"><i
                                                        class="a-icon-circle-arrow-up a-icon-gray"></i> VIP авто</a>
                                        </li>
                                        <li>
        ...
        {% elseif n.type == 'diagnostic' %}
            <div class="item pagination-block {% if is_admin and n.flag_moder_view == 0 %}no-moder-view{% endif %} {% if n.light_flag %}light{% endif %}">
                <div class="a-row a-offset-0">
                    <div class="a-cols-2 a-font-small a-color-gray-2"><a href="/diagnostic">Диагностика</a></div>
                    <div style="font-size:10px"
                         class="a-cols-4 a-font-small a-color-gray-2 a-align-right a-float-right">
                        {{ n.date_add|timeago }}
                    </div>
                ...
                <div class="offer clear">
                    {% if n.image != '' %}
                        <img title=" {{ n.name }}" alt=" {{ n.name }}"
                             src="/uploads/images/diagnostic/80x100/{{ n.image }}"/>
                    {% else %}
                        <img src="/uploads/images/100x80.jpg"/>
                    {% endif %}
                    <div class="offer-content">
                            ...
                            <li>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                        ...
                                        <li>
                                            <a class="ajax-link" href="/light-content-10-{{ n.content_id }}"><i
                                                        class="a-icon-tint a-icon-gray"></i> Выделить цветом</a>
                                        </li>
                                        <li>
                                            <a class="ajax-link" href="/add-to-top-10-{{ n.content_id }}"><i
                                                        class="a-icon-circle-arrow-up a-icon-gray"></i> VIP авто</a>
                                        </li>
                                        <li>
        ...
        {% elseif n.type == 'resume' %}
            <div class="item pagination-block {% if is_admin and n.flag_moder_view == 0 %}no-moder-view{% endif %} {% if n.light_flag %}light{% endif %}">
                <div class="a-row a-offset-0">
                    <div class="a-cols-2 a-font-small a-color-gray-2"><a href="/work/resume">Резюме</a></div>
                    <div style="font-size:10px"
                         class="a-cols-4 a-font-small a-color-gray-2 a-align-right a-float-right">
                        {{ n.date_add|timeago }}
                    </div>
                ...
                <div class="offer clear">
                    {% if n.image %}
                        <img title="n.name" src="/uploads/images/work/80x100/{{ n.image }}"/>
                    {% else %}
                        <img src="/uploads/images/100x80.jpg">
                    {% endif %}
                            ...
                            <li>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                        ...
                                        <li>
                                            <a class="ajax-link" href="/light-content-6-{{ n.content_id }}"><i
                                                        class="a-icon-tint a-icon-gray"></i> Выделить цветом</a>
                                        </li>
                                        <li>
                                            <a class="ajax-link" href="/add-to-top-6-{{ n.content_id }}"><i
                                                        class="a-icon-circle-arrow-up a-icon-gray"></i> VIP авто</a>
                                        </li>
                                        <li>
        ...
        {% elseif n.type == 'vacancies' %}
            <div class="item pagination-block {% if is_admin and n.flag_moder_view == 0 %}no-moder-view{% endif %} {% if n.light_flag %}light{% endif %}">
                <div class="a-row a-offset-0">
                    <div class="a-cols-2 a-font-small a-color-gray-2"><a href="/work/vacancy">Вакансии</a></div>
                    <div style="font-size:10px"
                         class="a-cols-4 a-font-small a-color-gray-2 a-align-right a-float-right">
                        {{ n.date_add|timeago }}
                    </div>
                ...
                <div class="offer clear">
                    {% if n.image != '' %}
                        <img title="{{ n.name }}" alt="{{ n.name }}" src="/uploads/images/work/80x100/{{ n.image }}"/>
                    {% else %}
                        <img src="/uploads/images/100x80.jpg">
                    {% endif %}
                    <div class="offer-content">
                            ...
                            <li>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                        ...
                                        <li>
                                            <a class="ajax-link" href="/add-to-top-15-{{ n.content_id }}"><i
                                                        class="a-icon-circle-arrow-up a-icon-gray"></i> VIP авто</a>
                                        </li>
                                        <li>
