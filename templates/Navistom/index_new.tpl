            ...
            <ul class='soc'>
                <li>
                    <a href='https://www.facebook.com/navistom'>
                        <div class='f_soc' target='_blank'></div>
                    </a>
                </li>
                <li>
                    <a href='https://twitter.com/navistom'>
                        <div class='t_soc' target='_blank'></div>
                    </a>
                </li>
                <li>
                    <a href='http://vk.com/id95980050'>
                        <div class='v_soc' target='_blank'></div>
                    </a>
                </li>
                <li>
...
<link href='http://fonts.googleapis.com/css?family=PT+Sans:400,700|PT+Sans+Narrow|Roboto:100,300,400,700&subset=latin,cyrillic'
