...
{% block content %}
    ...
    <div class="a-row roboto18">
        ...
        {% else %}
            <div class="a-cols-3">
                <a title="Добавить Акцию" href="/products/stock"><i class="a-icon-actionss a-icon-gray"></i> Добавить
                    Акцию</a>
            </div>
        {% endif %}
    </div>
        ...
        <div class="item pagination-block {% if is_admin and p.flag_moder_view == 0 %}no-moder-view{% endif %} {% if p.light_flag %}light{% endif %} {% if p.color_yellow %} color_yellow {% endif %}">
            ...
            <div class="offer clear">
                ...
                <div class="offer-content">
                    ...
                    <div class='name_ta'>
                        {% if p.stock_flag %}<span style='color:#C2185B'>Акция!</span>{% endif %}
            ...
            {% if p.user_id == user_info.info.user_id or is_admin %}
                <ul class="options clear">
                    ...
                    <li>
                        ...
                        {% else %}
                            <a href="/product/flag-{{ p.product_new_id }}-1"><i class="a-icon-eye-open a-icon-gray"></i>
                                Отобразить</a>
                        {% endif %}
                    </li>
                    <li>
            ...
            {% endif %}
                    ...
                    {% if is_admin %}
                        <li class="call">
                            {% if p.call_d %}
                                <a href="/products/no-pay-call-{{ p.user_id }}">
                                    <div class='call_red ' user="{{ p.user_id }}"></div>
                                </a>
                            {% else %}
                                <a href="/products/no-pay-call-{{ p.user_id }}">
                                    <div class='call_green' user='{{ p.user_id }}'></div>
                                </a>
                            {% endif %}
                        </li>
                    {% endif %}
    ...
    {% if pagination.pages %}
        <ul class="a-pagination">
            <li class="first-page {% if route.values.page == 1 or route.values.page == 0 %}active{% endif %}">
                ...
                {% else %}
                    <a href="/products/{{ pagination.first.url }}/nopay-2">{{ pagination.first.name }}</a>
                {% endif %}
            </li>
            <li>
                {% if pagination.prev_page %}
                    ...
                    {% else %}
                        <a href="/products/{{ pagination.prev_page }}/nopay-2">«</a>
                    {% endif %}
                {% endif %}
            </li>
            {% for p in pagination.pages %}
                <li {% if route.values.page==p.name or (route.values.page==0 and p.name==1) %} class="active" {% endif %}>
                    ...
                    {% else %}
                        <a href="/products/{{ p.url }}/nopay-2">{{ p.name }}</a>
                    {% endif %}
                </li>
            {% endfor %}
            <li class="next-posts">
                {% if pagination.next_page %}
                    {% if route.values.user_id > 0 %}
                        <a href="/products/{{ pagination.next_page }}{{ url }}/nopay-2">»</a>
                    {% elseif route.values.categ_id > 0 %}
                        {% if route.values.producer_id > 0 %}
                    ...
                    {% else %}
                        <a href="/products/{{ pagination.next_page }}/nopay-2">»</a>
                    {% endif %}
                {% endif %}
            </li>
            {% if pagination.last.url %}
                <li class="last-page">
                    ...
                    {% else %}
                        <a href="/products/{{ pagination.last.url }}/nopay-2">{{ pagination.last.name }}</a>
                    {% endif %}
                </li>
            {% endif %}
        </ul>
