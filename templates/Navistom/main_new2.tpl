...
{% block content %}
    ...
    {% for n in news %}
        {% if n.type == 'products_new' %}
            <div class="item pagination-block {% if is_admin and n.flag_moder_view == 0 %}no-moder-view{% endif %} {% if n.light_flag %}light{% endif %} {% if n.color_yellow %} color_yellow{% endif %}">
                ...
                <div class=" clear">
                    {% if n.image != '' %}
                        <!--a title="{{ p.product_name }}" href="/product/{{ n.content_id }}-{{ n.name|translit }}" class="ajax-link image_pad"><img title="{{ n.name }}" src="/uploads/images/products/142x195/{{ n.image }}"></a-->
                        <a title="{{ p.product_name }}" href="/product/{{ n.content_id }}-{{ n.name|translit }}"
                           class="ajax-link image_pad"><img title="{{ n.name }}"
                                                            src="/uploads/images/{% if n.image != '' %}{% if isBigImg(n.image) %}products/142x195/{{ n.image }}{% else %}products/80x100/{{ n.image }}{% endif %}{% else %}100x80.jpg{% endif %}"></a>
                    {% else %}
                        <a title="{{ p.product_name }}" href="/product/{{ n.content_id }}-{{ n.name|translit }}"
                           class="ajax-link image_pad"><img title="{{ n.name }}" src="/uploads/images/100x80.jpg"></a>
                    {% endif %}
                    <div class="offer-content">
                        ...
                        <div class='name_ta'>
                            <a title="{{ p.product_name }}" href="/product/{{ n.content_id }}-{{ n.name|translit }}"
                               class="ajax-link">{% if n.flag_stock %}Акция!{% endif %} {{ n.name }}</a>
                        </div>
  ...
  {% if(n.group_id !=10) %}
      ...
      {% if n.time_show <9 %}
          | <a href='/success-{{ n.content_id }}-3-extend' class='success_link'>продлить</a>
      {% endif %}
  {% else %}
      Опубликовано
  {% endif %}
                                ...
                                {% else %}
                                    <div class='nopay'><span class='red2'> не оплачено | <a
                                                    href='/success-{{ n.content_id }}-3-top'>оплатить</a></span></div>
                                {% endif %}
                            {% endif %}
                        </li>
                    </ul>
                ...
                <div class=" clear">
                    {% if n.image != 'products/80x100/' %}
                        <a title="{{ n.name }}, Б/У" href="/ads/{{ n.content_id }}-{{ n.name|translit }}"
                           class="ajax-link image_pad"><img title="{{ n.name }}, Б/У" alt="{{ n.name }}, Б/У"
  ...
  {% endif %}
            ...
            <div class="item pagination-block {% if is_admin and n.flag_moder_view == 0 %}no-moder-view{% endif %} {% if n.light_flag %}light{% endif %} {% if n.color_yellow %} color_yellow{% endif %}">
                ...
                <div class=" clear">
                    {% if n.image %}
                        <div class="lector-image">
                            <a title="{{ n.name }}" href="/activity/{{ n.content_id }}-{{ n.name|translit }}"
                               class="ajax-link image_pad" style="display:block"><img title="{{ n.name }}"
                                                                                      alt="{{ n.name }}"
                    ...
                    <div class="offer-content gs">
                        ...
                        <div class='name_ta'>
                            <a title="{{ n.name }}" href="/activity/{{ n.content_id }}-{{ n.name|translit }}"
                               class="ajax-link ">{{ n.name|raw }} г. {{ n.price_description }}</a>
                        </div>
                        <div class="a-row a-offset-0 offer-footer">
                            <div class="a-cols-2">
                                <a title="{{ n.user_name }}" data-user_id="{{ n.user_id }}"
                ...
                <div class=" clear">
                    {% if n.image != '' %}
                        <a title="{{ n.name }}" href="/service/{{ n.content_id }}-{{ n.name|translit }}"
                           class="ajax-link n-ad-title-price image_pad"><img title="{{ n.name }}"
                    ...
                    <div class="offer-content">
                        ...
                        <div class='ic'>
                            <a target="_blank" title="{{ n.name }}"
                               href="/service/{{ n.content_id }}-{{ n.name|translit }}" class="modal-window-link"></a>
                        </div>
                        <div class='name_ta'>
                            <a title="{{ n.name }}" href="/service/{{ n.content_id }}-{{ n.name|translit }}"
                ...
                <div class=" clear">
                    {% if n.image != '' %}
                        <a title="{{ n.name }}" href="/demand/{{ n.content_id }}-{{ n.name|translit }}"
                           class="ajax-link n-ad-title-price image_pad"><img title="{{ n.name }}" alt="{{ n.name }}"
                    ...
                    <div class="offer-content">
                        ...
                        <div class='ic'>
                            <a target="_blank" title="{{ n.name }}"
                               href="/demand/{{ n.content_id }}-{{ n.name|translit }}" class="modal-window-link"></a>
                        </div>
                        <div class='name_ta'>
                            <a title="{{ n.name }}" href="/demand/{{ n.content_id }}-{{ n.name|translit }}"
                               class="ajax-link n-ad-title-price">
                ...
                <div class=" clear">
                    ...
                    <div class="offer-content">
                        ...
                        <div class='name_ta'>
                            <a title="{{ n.name }}" href="/lab/{{ n.content_id }}-{{ n.name|translit }}"
                               class="ajax-link n-ad-title-price">
                                {{ n.name|raw }} г. {{ n.description|raw }}
                            </a>
                        </div>
                        <div class="a-row a-offset-0 offer-footer">
                            <div class="a-cols-2">
                ...
                <div class=" clear">
                    {% if n.image %}
                        <a title="{{ n.name }}" href="/work/resume/{{ n.content_id }}-{{ n.name|translit }}"
                           class="ajax-link image_pad"><img title="n.name"
                                                            src="/uploads/images/work/160x200/{{ n.image }}"/></a>
                    {% elseif n.description %}
                        <a title="{{ n.name }}" href="/work/resume/{{ n.content_id }}-{{ n.name|translit }}"
                           class="ajax-link image_pad"><img title="n.name"
                                                            src="/uploads/users/avatars/full/{{ n.description }}"></a>
                    {% else %}
                ...
                <div class=" clear">
                    {% if n.image != '' %}
                        <a title="{{ n.name }}" href="/work/vacancy/{{ n.content_id }}-{{ n.name|translit }}"
                           class="ajax-link image_pad"><img title="{{ n.name }}" alt="{{ n.name }}"
    ...
    <ul class="ads-sections scroll-sections">
        ...
        <li><a title="Аренда/Продажа" class="big-icon-realty" href="/realty"></a></li>
