...
<h1 class="n-form-title">
    <span>Разместить свое резюме</span>
    <div class="n-title-desc"><font class="a-red">*</font> Поля, обязательные для заполнения</div>
</h1>
{% if is_add_access %}
<form id="activity-add-form" class="n-add-form a-clear" method="post" enctype="multipart/form-data" action="/index.ajax.php?route=/work/resume_add_ajax">
	<div class="a-row">
