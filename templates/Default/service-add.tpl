...
<h1 class="n-form-title">
    <span>Добавить предложение по сервису</span>
    <div class="n-title-desc"><font class="a-red">*</font> Поля, обязательные для заполнения</div>
</h1>
{% if is_add_access %}
<form id="activity-add-form" class="n-add-form a-clear" method="post" enctype="multipart/form-data" action="/index.ajax.php?route=/service/add_ajax">
	<div class="a-row">
    ...
    <div class="a-row n-title-description">
        ...
        <div class="n-ad-add-desc a-clear">
            ...
            <div class="a-clear">
                ...
                <div class="col-2">
                    ачинайте с ключевого слова: СЕРВИСНЫЙ ЦЕНТР, РЕМОНТ, ТЕХНИЧЕСКОЕ ОБСЛУЖИВАНИЕ, ЗАПАСНЫЕ ЧАСТИ и т.д.
                </div>
            </div>
            <div class="a-clear">
                <div class="col-1">
