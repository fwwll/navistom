                    ...
                    <div class="n-ad a-clear">
                        ...
                        <div class="col-2">
                        	<div class="n-ad-top-info">
                            	<div class="col-1">
                                	<a href="#">Зуботехнические услуги</a>
                                </div>
                                <div class="col-2">
                            ...
                            <a href="#" class="n-ad-title">Помощь зубным техникам в работе с гибкими протезами!</a>
                            
                            <div class="n-ad-info n-ad-info-address">
                            	<div class="col-1">
                                	<span class="navi-bg-green"><i class="a-icon-phone a-icon-white"></i></span> (032) 260-14-64
                                </div>
                                <div class="col-2">
                                	<a href="#">
                                ...
                                <div class="col-3">
                                	<a href="#">
                                    	<span class="navi-bg-blue"><i class="a-icon-globe a-icon-white"></i></span> г. Киев, ул. Смелянская 17А
                                    </a>
                                </div>
                            </div>
                        </div>
