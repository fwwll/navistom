            	...
            	<div class="col-1">
                	<div class="navi-ads-filter navi-new-filter">
                    	<form method="post" action="">
                        	<select class="select-2 category" id="category" name="category">
                            	<option value="0">Все рубрики</option>
                            </select>
                            <select class="select-2 sub_category" id="sub_category" name="sub_category">
                            	<option value="0">Все разделы</option>
                            </select>
                            <select class="select-2 firms" id="firms" name="firms">
                            	<option value="0">Все производители</option>
                            </select>
                            
                            <select class="select-2 products" id="products" name="products">
                            	<option value="0">Все товары</option>
                            </select>
                            
                            <input type="button" class="a-btn-red" value="Акционные" />
                        </form>
                    </div>
                    ...
                    <div class="n-ad a-clear">
                        ...
                        <div class="col-2">
                            <a href="#" class="n-ad-title-price n-ad-title-new">
                            	<span class="navi-stock-marker">Акция</span> KAESER DENTAL DENTAL 5-2
                                <div class="n-ad-description">Компрессор стоматологический</div>
                            </a>
