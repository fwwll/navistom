	...
	<div class="navi-body">
        ...
        <div class="navi-parent">
            ...
            <div class="navi-row-2">
            	<div class="col-1">
                	<ul class="idTabs a-clear navi-tabs-large">
                    	<li>
                        	<a href="#">Резюме</a>
                        </li>
                        <li>
                	...
                	<div class="navi-ads-filter navi-new-filter">
                    	<form method="post" action="">
                            ...
                            <select class="select-2 firms" id="region" name="region">
                            	<option value="0">Все регионы</option>
                            </select>
                            
                            <select class="select-2 products" id="price" name="price">
                    ...
                    <div class="n-ad a-clear">
                        ...
                        <div class="col-2">
                            ...
                            <a href="#" class="n-ad-title-price">Требуется врач-стоматолог, ассистент стоматолога</a>
                            
                            <div class="n-ad-price">з/п 4000 грн.</div>
