...
<form id="activity-add-form" class="n-add-form a-clear" method="post" enctype="multipart/form-data" action="/index.ajax.php?route=/service/edit_ajax-{{data.service_id}}">
	<div class="a-row">
