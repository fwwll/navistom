...
class TimeAgo {
  ...
  public function inWords($past, $now = "now") {
    ...
    // between 1min30secs and 44mins29secs
      ...
      $timeAgo = $minutes." " . Str::get($minutes)->getVariantsByInt('минут', 'минута', 'минуты');
    }
    ...
    // between 1hour29mins30secs and 23hours59mins29secs
      ...
      $timeAgo = $hours ." " . Str::get($hours)->getVariantsByInt('часов', 'час', 'часа');
    }
    ...
    // between 47hours59mins30secs and 29days23hours59mins29secs
      ...
      $timeAgo = $days ." " . Str::get($days)->getVariantsByInt('дней', 'день', 'дня');
    }
    ...
    // between 59days23hours59mins30secs and 1year (minus 1sec)
      ...
      $timeAgo = $months ." " . Str::get($months)->getVariantsByInt('месяцев', 'месяц', 'месяца');
    }
    ...
    // 2years or more
      ...
      $timeAgo = "больше ".$years ." " . Str::get($years)->getVariantsByInt('лет', 'года', 'лет');
    }
