    ...
    <table class="a-table tablesorter sortable"> 
        ...
        <tbody id="services/category"> 
            ...
            <tr id="categ-{{c.categ_id}}">
            	<td>{{c.categ_id}}</td> 
            	<td>
                	<a href="/admin/services/category/edit-{{c.categ_id}}">{{c.name}}</a>
                </td>
                <td>{{c.date_add|rusDate}}</td>
                <td>{{c.date_edit|rusDate}}</td>
                <td class="ad-table-option">
                	<a href="/admin/services/category/edit-{{c.categ_id}}"><i class="a-icon-pencil"></i></a>
                    <a title="{{c.name}}" class="delete-link" href="/admin/services/category/delete-{{c.categ_id}}"><i class="a-icon-remove"></i></a>
                </td>
            </tr>
            {% endfor %}
        </tbody> 
