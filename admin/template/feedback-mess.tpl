...
{% block content %}
    ...
    {% for d in data %}
    	<li {% if d.flag_view == 0%} style="background: #fffcd4" {%endif%}>
        	...
        	<div class="comm-content">{{d.message|nl2br}}</div>
            ...
            <span class="comm-user"><i class="a-icon-user"></i> {{d.user_name}}</span>
            <span class="comm-options">
            	<a class="delete-link" href="/admin/feedback/delete-{{d.mess_id}}"><i class="a-icon-remove"></i></a>&nbsp;
                {% if d.flag_view == 0%}
                <a href="/admin/feedback/view-{{d.mess_id}}"> <i class="a-icon-ok"></i></a>
                {% endif %}
            </span>
            ...
            <form method="post" class="ad-form a-clear validation" action="/admin/index.ajax.php?route=feedback/send-message-{{d.mess_id}}">
            	<div class="a-row">
